...
export default function single({ post, category }) {
  return (
    <div className="listNew ">
      <button
        type="button"
        className="relative  inline-flex content-start  w-full px-0 py-2 text-sm font-medium border-b border-gray-200 rounded-t-lg  hover:text-blue-700 focus:z-10 focus:ring-2"
      >
