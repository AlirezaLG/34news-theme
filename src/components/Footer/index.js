...
export default function ({ footerMenu1, footerMenu2, footerMenu3 }) {
  return (
    <div className="bg-primary pt-5">
      <div className="container py-10 text-white grid md:grid-cols-2 gap-5 xs:grid-cols-1">
        <div className="grid md:grid-cols-3 xs:grid-cols-1">
          <div className="col-span-2 	">
            ...
            <p className="py-5">
              Pellentesque posuere. Praesent congue erat at massa. In ut quam
      ...
      <div className="container border-t border-[#5882CD]  text-center py-5 text-white">
        <p>
          {" "}
          Copyright @ 2024 34news.com | All right reserved | Design and
          Developted by <Link href="#">Techsharks</Link>
        </p>
      </div>
    </div>
  );
